...
export function Footer() {
  ...
  return (
    <>
      {/* Changed bg to primary */}
      <footer className="relative overflow-hidden bg-primary pt-24 text-white sm:pt-32" role="contentinfo">

        {/* Massive Full-Size Luxury Watermark (Adjusted opacity for primary bg) */}
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-6 lg:px-8">
          <div className="grid gap-16 md:grid-cols-2 lg:grid-cols-12 lg:gap-8">
            ...
            <div className="lg:col-span-4 lg:pr-8">
              <div className="flex items-center gap-4">
                {/* Added a subtle white background to ensure the logo is visible on primary color */}
                <div className="flex h-16 w-16 items-center justify-center rounded-full bg-white p-2 shadow-lg">
                  <img src={Logo} alt={`${SITE.shortName} logo`} className="h-full w-full object-contain rounded-full" />
                </div>
                <div>
                  <p className="font-display text-2xl font-bold tracking-tight text-white">{SITE.shortName}</p>
                  <p className="text-[10px] font-bold uppercase tracking-[0.25em] text-white/80">Ladies Hostel Trichy</p>
                </div>
              </div>
              ...
              {/* Premium Social Links (Inverted for primary bg) */}
              <div className="mt-8 flex gap-4">
                <a
                  href={SITE.social.facebook}
                  className="group flex h-10 w-10 items-center justify-center rounded-full border border-white/20 transition-all duration-300 hover:border-white hover:bg-white/10"
                  aria-label="Follow us on Facebook"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <svg className="h-4 w-4 fill-white/80 transition-colors group-hover:fill-white" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <div className="lg:col-span-2">
              <h3 className="text-[10px] font-bold uppercase tracking-[0.25em] text-white/60 mb-6">Navigation</h3>
            ...
            <div className="lg:col-span-2">
              <h3 className="text-[10px] font-bold uppercase tracking-[0.25em] text-white/60 mb-6">Amenities</h3>
              <ul className="space-y-4">
                {FACILITIES.slice(0, 5).map((facility) => (
                  <li key={facility.title}>
                    <span className="text-sm font-medium text-white/80">{facility.title}</span>
                  </li>
                ))}
              </ul>
            </div>
            ...
            <div className="lg:col-span-4">
              <h3 className="text-[10px] font-bold uppercase tracking-[0.25em] text-white/60 mb-6">Contact Us</h3>
                ...
                <li>
                  ...
                  >
                    <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-white/10 transition-colors group-hover:bg-white/20">
                      <Phone className="h-3.5 w-3.5 text-white/90 group-hover:text-white" aria-hidden="true" />
                    </div>
                    <span className="mt-1.5 text-sm font-medium text-white/90">{SITE.phone}</span>
                  </a>
                </li>
                <li>
                  <a
                  ...
                  >
                    <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-white/10 transition-colors group-hover:bg-white/20">
                      <Mail className="h-3.5 w-3.5 text-white/90 group-hover:text-white" aria-hidden="true" />
                    </div>
                    <span className="mt-1.5 text-sm font-medium text-white/90">{SITE.email}</span>
                  </a>
                </li>
                <li>
                  <div className="flex items-start gap-4">
                    <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-white/10">
                      <MapPin className="h-3.5 w-3.5 text-white/90" aria-hidden="true" />
                    </div>
                    <div className="mt-1.5 flex flex-col items-start gap-2">
                      ...
                      <a
                        href={SITE.mapsUrl}
                        className="group flex items-center gap-2 text-[10px] font-bold uppercase tracking-wider text-white"
                        target="_blank"
                        rel="noopener noreferrer"
                      >
                        <span className="border-b border-white/40 transition-colors group-hover:border-white">View on Maps</span>
                      </a>
                    </div>
                  </div>
                </li>
          ...
          <div className="mt-20 border-t border-white/20 py-8 flex flex-col items-center justify-between gap-4 md:flex-row text-xs text-white/70 font-medium">
            <p>
